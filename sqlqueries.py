queries = {
    ...
    "update vaccination_by_municipality set CUMUL = 5 where cumul = '<10'"  # If this line returns "Truncated incorrect DOUBLE value: '<10'   
                                                                          # then it means it already set the correct double
    }